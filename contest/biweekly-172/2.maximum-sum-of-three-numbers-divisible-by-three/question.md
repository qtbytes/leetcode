# [3780. Maximum Sum of Three Numbers Divisible by Three][link] (Medium)

[link]: https://leetcode.com/contest/biweekly-contest-172/problems/maximum-sum-of-three-numbers-divisible-by-three/

You are given an integer array `nums`.

Your task is to choose **exactly three** integers from `nums` such that their sum is divisible by
three.
