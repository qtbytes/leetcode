# [909. Snakes and Ladders][link] (Medium)
...
destination of that snake or ladder is `board[r][c]`. Squares `1` and `n²` are not the starting
...
Return the least number of dice rolls required to reach the square  `n²`. If it is not possible to
