# [3217. Delete Nodes From Linked List Present in Array][link] (Medium)
...
- `1 <= Node.val <= 10⁵`
- The input is generated such that there is at least one node in the linked list that has a value not
present in `nums`.
