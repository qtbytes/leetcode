# [3652. Best Time to Buy and Sell Stock using Strategy][link] (Medium)
...
You are also given an **even** integer `k`, and may perform **at most one** modification to
`strategy`. A modification consists of:
