# [3713. Longest Balanced Substring I][link] (Medium)
...
The longest balanced substring is `"zabc"` because the distinct characters `'z'`, `'a'`, `'b'`, and
`'c'` each appear exactly 1 time.
